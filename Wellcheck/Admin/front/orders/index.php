					...
					<ul class="list-group col-12 modalelist" style="height: auto;max-height: 400px;">
						...
						<li class="list-group-item">
							...
							<div class="col-12"></div>
								<div style="text-align: end" class="hidemd col-3" for="'userid_' + order.id">User :</div>
								...
								<div style="text-align: end" class="hidemd col-3" for="'devices_' + order.id">Devices ordered :</div>
								<div style="text-align: left" class="col-9" id="devices_<?php echo $order->id ?>"><?php echo $order->details->devicesNumber ?></div>
								<div style="text-align: end" class="hidemd col-3" for="'price_' + order.id">Total Price : </div>
