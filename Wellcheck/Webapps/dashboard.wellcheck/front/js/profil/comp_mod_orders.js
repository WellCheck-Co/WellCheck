              ...
              <div class="container">
                <div class="row">
                  <div v-if="page == 0 && orders.length > 0" class="col-12">
                    <div class="col-sm-12 col-12 margin5px" for="input2">{{ orders.length > 1 ? "Your orders" : "Your order" }}</div>
                    </br>
                    ...
                    <ul class="list-group col-12 modalelist" style="height: auto;max-height: 400px;">
                      <li v-for="order in orders" class="list-group-item list-group-item-action" v-on:click="getOrder(order.id)">
                        <div class="row justify-content-md-center">
                          ...
                          <div style="text-align: end" class="col-3" :for="'id_' + order.id">Identifier :</div>
