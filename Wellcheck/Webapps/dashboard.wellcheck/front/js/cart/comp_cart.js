                      ...
                      <container note="Enter your billing and shipping informations"
                        ...
                        <container note="Choose or add a billing address"
                          ...
                          <div v-if="addresses.length > 0" class="col-12">
                            <div class="hidemd col-sm-12 col-12 margin5px" for="input2">{{ addresses.length > 1 ? "Your address" : "Your addresses" }}</div>
                            </br>
                              ...
                              <div class="row">
                                <div class="col-12" v-for="input in modalInputs">
                                  <div class="container">
                                    <div class="row">
                                      <div class="sepinput"></div>
                                      <div class="hidemd col-3" :for="'address_' + input.name">{{input.label}}</div>
